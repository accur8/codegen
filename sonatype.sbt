...
ThisBuild / homepage := Some(url("https://github.com/accur8/codegen"))
ThisBuild / scmInfo := Some(ScmInfo(url("https://github.com/accur8/codegen"), "scm:git@github.com:accur8/codegen.git"))
